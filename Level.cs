...
//    private ShortestPathAlgorithm shortestPathAlgo;
...
//          if (!levelData.GetCell(new Vector2Int(i, j)). == TileType.Walkable)
...
//    private void Start()
//    {
//      shortestPathAlgo = new BreadthFirstSearch(levelData);
